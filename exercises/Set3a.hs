...
firstHalf xs = if length xs `mod` 2 == 0 then take (length xs `div` 2) xs
...
while check update value = if check value == True then while check update (update value)
                           else value
...
interpreter' [] x y = []
interpreter' (com:commands) x y = if com == "up" then interpreter' commands x (y+1)
                                  else if com == "down" then interpreter' commands x (y-1)
                                  else if com == "left" then interpreter' commands (x-1) y
                                  else if com == "right" then interpreter' commands (x+1) y
                                  else if com == "printX" then show x : interpreter' commands x y
                                  else if com == "printY" then show y : interpreter' commands x y
                                  else interpreter' commands x y
